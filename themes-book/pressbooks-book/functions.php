...
function pressbooks_book_info_page () {
	...
	if ( is_front_page() ) {
		...
		wp_enqueue_style( 'book-info-fonts', '//fonts.googleapis.com/css?family=Droid+Serif:400,700|Oswald:300,400,700' );
